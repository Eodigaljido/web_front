...
**Nginx 서버 배포 (복사용 명령·설정·SSL):** [docs/nginx-deploy.md](./docs/nginx-deploy.md)

1. DNS `eodigaljido.uk` → Vercel / Cloudflare Pages / **자체 Nginx 서버**
...
CORS에 `https://eodigaljido.uk` origin을 허용해야 합니다.
